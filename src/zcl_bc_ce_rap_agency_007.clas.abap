CLASS zcl_bc_ce_rap_agency_007 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zbc_travel_agency_es5-AgencyId.
    TYPES t_business_data TYPE TABLE OF zbc_travel_agency_es5.
...
CLASS zcl_bc_ce_rap_agency_007 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZBC_SC_RAP_AGENCY_007' ).
